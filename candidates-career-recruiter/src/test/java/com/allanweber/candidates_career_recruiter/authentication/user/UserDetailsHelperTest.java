package com.allanweber.candidates_career_recruiter.authentication.user;
...
import com.allanweber.candidates_career_recruiter.authentication.user.service.UserDetailsHelper;
...
class UserDetailsHelperTest {
    ...
    void loadCommonUser() {
        ...
        Assertions.assertEquals(AuthoritiesHelper.ROLE_USER, userDetails.getAuthorities().iterator().next().getAuthority());
