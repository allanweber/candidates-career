...
import com.allanweber.candidatescareer.domain.user.registration.repository.ChangePassword;
import com.allanweber.candidatescareer.domain.user.registration.repository.ChangePasswordRepository;
