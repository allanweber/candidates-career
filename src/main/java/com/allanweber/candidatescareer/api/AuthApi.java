...
public interface AuthApi {
    ...
    @ApiOperation(notes = "Execute user login", value = "Execute user login")
    @ApiResponses({
    ...
    @ApiOperation(notes = "Refresh user token", value = "Refresh user token")
    @ApiResponses({
    ...
    @ApiOperation(notes = "Check if user is Admin role", value = "Check if user is Admin role")
    @ApiResponses({
    ...
    @ApiOperation(notes = "Check if user is authenticated", value = "Check if user is authenticated")
    @ApiResponses({
